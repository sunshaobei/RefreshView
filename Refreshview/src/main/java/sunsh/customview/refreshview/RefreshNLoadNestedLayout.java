...
public class RefreshNLoadNestedLayout extends LinearLayout implements NestedScrollingParent,
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
        ...
        return isEnabled() && getRefresh().HmState == RefreshRecyclerView4Nested.STATE_DEFAULT && getLoadMore().FmState == RefreshNLoadNestedRecyclerView.STATE_DEFAULT //没有在刷新和返回途中
