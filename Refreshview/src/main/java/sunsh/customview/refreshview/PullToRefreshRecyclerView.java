...
import sunsh.customview.refreshview.RefreshNLoadNestedLayout;
...
/**
 * Created by sunsh on 2017/10/23.
 */
public class PullToRefreshRecyclerView extends HeaderAndFooterRecyclerView {
    ...
    public PullToRefreshRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
        RefreshNLoadNestedLayout refreshNLoadNestedRecyclerView = new RefreshNLoadNestedLayout(context);
