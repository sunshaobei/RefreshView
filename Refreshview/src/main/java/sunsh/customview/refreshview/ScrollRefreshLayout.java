...
import sunsh.customview.refreshview.loadinglayout.DefaultLoadingLayout;
import sunsh.customview.refreshview.loadinglayout.ILoadingLayout;
import sunsh.customview.refreshview.util.DensityUtil;


/**
 * Created by sunsh on 2017/9/12.
 */

public class ScrollRefreshLayout extends FrameLayout implements NestedScrollingParent {
    ...
    public ScrollRefreshLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
        ...
        if ((isPullHeader && enableRefresh) || (isPullFooter && enableLoadMore)) {
            scrollBy(0, dy);
            consumed[1] = dy;
        }
